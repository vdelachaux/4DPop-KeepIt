...
C_TEXT:C284($File_test; $Txt_errorMethod; $Txt_pathname)
C_OBJECT:C1216($Obj_folder)
...
Else 
	...
	$Obj_folder.exist:=False:C215
	$Obj_folder.fullName:=""
	$Obj_folder.nativePath:=""
	$Obj_folder.path:=""
